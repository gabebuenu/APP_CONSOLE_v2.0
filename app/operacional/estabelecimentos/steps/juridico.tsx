  ...
  return (
    <div className="w-full">
      <div className="mb-6 w-full">
        <h3 className="text-base font-semibold text-gray-900 mb-2">Jurídico</h3>
        <p className="text-sm text-gray-600">Contratos e documentação jurídica</p>
      </div>

      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 w-full">
        <h4 className="text-sm font-semibold text-blue-800 mb-2">Onde os contratos serão armazenados?</h4>
      ...
      <div className="w-full">
        <div
          className={`border-2 border-dashed rounded-xl p-8 text-center w-full transition-colors ${
        ...
        >
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-sm text-gray-600 mb-3">Arraste e solte arquivos aqui ou</p>
            <label className="cursor-pointer px-4 py-2 bg-[#169BFF] text-white text-sm rounded-lg hover:bg-blue-600 transition-colors font-medium">
              Selecionar arquivos
        ...
        {data.contratos.length > 0 ? (
          <div className="mt-6 w-full">
            <h4 className="text-sm font-medium text-gray-700 mb-3">Arquivo(s) Enviado(s)</h4>
              ...
              {data.contratos.map((file, index) => (
                ...
                >
                  <div className="flex items-center flex-1 min-w-0">
                    <div className="w-8 h-8 bg-red-100 rounded flex items-center justify-center mr-3 flex-shrink-0">
          ...
          <div className="mt-6 text-center text-gray-500 w-full">
            <p className="text-sm">Nenhum arquivo enviado até o momento.</p>
          </div>
        )}

        <div className="pt-6 flex justify-between border-t border-gray-200 w-full mt-6">
          <button
            onClick={onPrev}
