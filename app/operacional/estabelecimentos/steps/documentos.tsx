  ...
  return (
    <div className="w-full">
      <div className="mb-6 w-full">
        <h3 className="text-base font-semibold text-gray-900 mb-2">Documentos</h3>
        <p className="text-sm text-gray-600">Documentação necessária para o credenciamento</p>
      </div>

      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 w-full">
        <h4 className="text-sm font-semibold text-blue-800 mb-2">Onde os documentos serão armazenados?</h4>
