...
export default function GruposEconomicosPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-sm font-medium text-gray-900 mb-1">Unidade de Negócios</h1>
        <p className="text-xs text-gray-500 mb-6">Gestão de Unidade de Negócios</p>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-orange-800">
              Não é possível excluir um registro caso tenha estabelecimentos vinculados.
            </p>
          </div>
        </div>
      </div>
