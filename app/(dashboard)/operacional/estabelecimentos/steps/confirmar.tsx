  ...
  return (
    <div className="w-full">
      <div className="mb-6 w-full">
        <h3 className="text-base font-semibold text-gray-900 mb-2">Confirmar</h3>
        <p className="text-sm text-gray-600">Revisão e confirmação dos dados inseridos</p>
      </div>

      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 w-full">
        <h4 className="text-sm font-semibold text-blue-800 mb-2">Revisão e confirmação dos dados</h4>
        <p className="text-sm text-blue-700 leading-relaxed">Verifique todos os dados antes de finalizar o cadastro.</p>
      </div>
      ...
      <div className="space-y-6 w-full">
        ...
        <div className="border border-gray-200 rounded-xl p-4 w-full">
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-base font-semibold text-gray-800">Dados comerciais</h4>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-2 gap-x-6 gap-y-3 w-full">
        ...
        <div className="border border-gray-200 rounded-xl p-4 w-full">
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-base font-semibold text-gray-800">Representante Comercial</h4>
            <button className="text-[#169BFF] hover:text-blue-700 flex items-center text-sm font-medium">
              <Edit className="h-4 w-4 mr-1" /> EDITAR DADOS
            </button>
          </div>
        ...
        <div className="border border-gray-200 rounded-xl p-4 w-full">
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-base font-semibold text-gray-800">Endereço Comercial</h4>
            <button className="text-[#169BFF] hover:text-blue-700 flex items-center text-sm font-medium">
              <Edit className="h-4 w-4 mr-1" /> EDITAR DADOS
            </button>
          </div>
        ...
        <div className="border border-gray-200 rounded-xl p-4 w-full">
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-base font-semibold text-gray-800">Recebimento das Vendas</h4>
            <button className="text-[#169BFF] hover:text-blue-700 flex items-center text-sm font-medium">
              <Edit className="h-4 w-4 mr-1" /> EDITAR DADOS
            </button>
          </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 w-full">
          <h4 className="text-sm font-semibold text-yellow-800 mb-2">Cadastro do Acordo Comercial</h4>
        ...
        <div className="pt-6 flex justify-between border-t border-gray-200 w-full">
          ...
          <button
            ...
            className="px-6 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition-colors flex items-center shadow-sm"
          >
